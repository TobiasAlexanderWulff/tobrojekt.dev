...
<figure class="mx-auto w-full md:w-1/2 my-8">
  <img src="/projects/spline-vgp-projekt/optimized_sigmoid_spline_visualization.png" alt="Optimized Sigmoid Spline" class="rounded-lg shadow-md w-full" />
...
<figure class="mx-auto w-full md:w-3/4 my-8">
  <img src="/projects/spline-vgp-projekt/fashionmnist_combined_accuracy.png" alt="Kombinierte Genauigkeiten auf FashionMNIST" class="rounded-lg shadow-md w-full" />
  <figcaption class="text-center text-sm text-gray-500 mt-2 italic">
...
<figure class="mx-auto w-full md:w-2/3 my-8">
  <img src="/projects/spline-vgp-projekt/sigmoid_fashionmnist_overall_gradient_heatmap.png" alt="Heatmap Sigmoid" class="rounded-lg shadow-md w-full" />
  <figcaption class="text-center text-sm text-gray-500 mt-2 italic">
...
<figure class="mx-auto w-full md:w-2/3 my-8">
  <img src="/projects/spline-vgp-projekt/spline_fashionmnist_overall_gradient_heatmap.png" alt="Heatmap Spline" class="rounded-lg shadow-md w-full" />
  <figcaption class="text-center text-sm text-gray-500 mt-2 italic">
...
<figure class="mx-auto w-full md:w-1/2 my-8">
  <img src="/projects/spline-vgp-projekt/train_times.png" alt="Trainingszeiten" class="rounded-lg shadow-md w-full" />
  <figcaption class="text-center text-sm text-gray-500 mt-2 italic">
